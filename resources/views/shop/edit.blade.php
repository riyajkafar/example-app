        ...
        <div class="w-full sm:max-w-md mt-6 px-6 py-4 bg-white shadow-md overflow-hidden sm:rounded-lg">
            <form method="POST" action="{{ route('shops.update', $shop->id) }}">
                ...
                <div>
                    ...
                    <x-text-input id="name" class="block mt-1 w-full" type="text" name="name" :value="old('name', $shop->name)"
                ...
                <div>
                    ...
                    <x-text-input id="website" class="block mt-1 w-full" type="text" name="website"
                        :value="old('website', $shop->website)" required autofocus autocomplete="website" />
                ...
                <div>
                    ...
                    <x-text-input id="contact" class="block mt-1 w-full" type="text" name="contact"
                        :value="old('contact', $shop->contact)" required autofocus autocomplete="contact" />
                ...
                <div>
                    ...
                    <x-text-input id="address" class="block mt-1 w-full" type="text" name="address"
                        :value="old('address', $shop->address)" required autofocus autocomplete="address" />
